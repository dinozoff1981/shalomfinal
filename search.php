                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="GET">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" name="ticketnumber" value="<?php if(isset($_GET['ticketnumber'])){echo $_GET['ticketnumber'];} ?>" class="form-control">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['ticketnumber']))
                                    {
                                        ...
                                        $query = "SELECT * FROM shalom2 WHERE ticketnumber='$ticketnumber' ";
